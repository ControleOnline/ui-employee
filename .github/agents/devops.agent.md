---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/ui-employee, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/ui-employee`.
...
- Checkout local: `app-community/modules/controleonline/ui-employee`
